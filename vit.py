...
def vit_base_patch16_224(num_classes: int = 7, pretrained=False):
    """
...
def dinov2_vitb14_224(num_classes: int = 1000):
    """
    ViT-Base model (ViT-B/16) from original paper (https://arxiv.org/abs/2010.11929).
    ImageNet-1k weights @ 224x224, source https://github.com/google-research/vision_transformer.
    weights ported from official Google JAX impl:
...
def vit_base_patch8_224_in21k(num_classes: int = 21843, has_logits: bool = True):
    # 21843
    """
    ViT-Base model (ViT-B/16) from original paper (https://arxiv.org/abs/2010.11929).
    ImageNet-21k weights @ 224x224, source https://github.com/google-research/vision_transformer.
...
if __name__ == '__main__':
    model = vit_base_patch16_224(num_classes=7)
